...
import { CreateUserProfileCommand, CreateUserProfileDto } from '../../application/commands/create-user-profile.command';
import { UpdateUserProfileCommand, UpdateUserProfileDto } from '../../application/commands/update-user-profile.command';
...
export class UsersController {
    ...
    async deleteMe(@Req() request: any, @Body() body: any) {
        const uid = request.user.uid;
        await this.softDeleteUserCommand.execute(uid, uid, false, { reason: body?.reason });
    }
