...
export class SegmentService {
     ...
     */
    async getRouteRisk(city: string, polyline: string, timeString?: string): Promise<any> {
        ...
        const segments = await this.segmentRepository.findIntersectingSegments(city, wktLinestring, hourOfDay);
