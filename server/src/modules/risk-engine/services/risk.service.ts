...
export class RiskService {
    ...
    async getSpecificPointRisk(
        ...
        const cell = await this.hotspotRepository.findNearestCell(city, lng, lat, 200);
        ...
        const computedSpike = this.spikeService.computeSpikeNorm(cell.last_24h, cell.baseline_hour_avg);
