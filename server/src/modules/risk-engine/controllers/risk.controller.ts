...
import { GetRiskTilesDto, GetRiskHereDto, GetRouteRiskDto, GetTopCorridorsDto } from '../dto/risk.dto';
...
export class RiskController {
    ...
    @Get('here')
    @ApiOperation({ summary: 'Get risk score and components for a specific location' })
